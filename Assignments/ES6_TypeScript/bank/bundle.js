...
/***/ function(module, exports, __webpack_require__) {
	...
	var _account = __webpack_require__(298);

	var _symbols = __webpack_require__(299);

	var _iterators = __webpack_require__(300);

	var _generator = __webpack_require__(301);

	var _collection = __webpack_require__(302);

	var _promise = __webpack_require__(303);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _marked = [armstrongNumbers].map(regeneratorRuntime.mark);

	function testGenerator() {
	    console.log("inside test generator");
	    var armstrNo = armstrongNumbers();
	    try {
	...
	function armstrongNumbers() {
	    var num, reset;
	    return regeneratorRuntime.wrap(function armstrongNumbers$(_context) {
	        while (1) {
...
/***/ function(module, exports) {
	...
	var room1users = new Set(['user1', 'user2', 'user3']);
	var room2users = new Set(['user101', 'user201', 'user301']);

	var room1msgs = ['Hi', 'Hello', 'TestMsg', 'Whats going on'];
	var room2msgs = ['GM', 'Good Morning', 'Test', 'Test test'];
	...
	function getUsersFromChatRoom(room) {
	    var users = chatRooms.get(room + "Users");
	    return users;
	}

	function getMsgsFromChatRoom(room) {
	    var msgs = chatRooms.get(room + "Msgs");
	    return msgs;
	}
...
/***/ function(module, exports) {
	...
	var p1 = Promise.resolve({ x: 10 });
	var p2 = Promise.resolve({ y: 20 });

	function testPromise() {
	    Promise.all([p1, p2]).then(function (promises) {
	        var res = promises[0].x + promises[1].y;
	        console.log(res);
	    });
	}
